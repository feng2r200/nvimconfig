...
M.attach = function(client, buffer)
  ...
  local cfg = {
    ...
    doc_lines = 18, -- will show two lines of comment/doc(if there are more than two lines in doc, will be truncated);
  ...
  signature.setup(cfg, buffer)
  signature.on_attach(client, buffer)
end
