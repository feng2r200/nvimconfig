...
local plug_map = {
    ...
    -- Bufferline
    ["n|gt"]          = map_cr("BufferLinePick"):with_noremap():with_silent(),
    ...
    ["v|<leader>ca"]  = map_cr("lua vim.lsp.buf.range_code_action()"):with_noremap():with_silent(),
    ...
    -- Plugin Telescope
    ["n|<leader>fs"]  = map_cr("lua require('telescope.builtin').lsp_document_symbols{}"):with_noremap():with_silent(),
